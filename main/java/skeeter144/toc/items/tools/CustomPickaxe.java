...
public class CustomPickaxe extends ItemPickaxe{
	...
	public static Map<CustomPickaxe, Map<BlockHarvestableOre, Float>> pickaxeChances;
	...
	public static void initPickaxeChances() {
		pickaxeChances = new HashMap<CustomPickaxe, Map<BlockHarvestableOre, Float>>();
		
		pickaxeChances.put((CustomPickaxe) TOCItems.bronze_pickaxe, new HashMap());
		...
		pickaxeChances.put((CustomPickaxe) TOCItems.iron_pickaxe, new HashMap());
		...
		pickaxeChances.put((CustomPickaxe) TOCItems.steel_pickaxe, new HashMap());
		...
		pickaxeChances.put((CustomPickaxe) TOCItems.mithril_pickaxe, new HashMap());
		...
		pickaxeChances.put((CustomPickaxe) TOCItems.adamantite_pickaxe, new HashMap());
		...
		pickaxeChances.put((CustomPickaxe) TOCItems.runite_pickaxe, new HashMap());
		...
		pickaxeChances.put((CustomPickaxe) TOCItems.dragonstone_pickaxe, new HashMap());
