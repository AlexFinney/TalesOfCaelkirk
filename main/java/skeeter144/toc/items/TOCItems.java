...
public class TOCItems {
	...
	public static Item bronze_pickaxe = new CustomPickaxe("pickaxe_bronze", BRONZE);
	public static Item iron_pickaxe = new CustomPickaxe("pickaxe_iron", IRON);
	public static Item steel_pickaxe = new CustomPickaxe("pickaxe_steel", STEEL);
	public static Item mithril_pickaxe = new CustomPickaxe("pickaxe_mithril", MITHRIL);
	public static Item adamantite_pickaxe = new CustomPickaxe("pickaxe_adamantite", ADAMANTITE);
	public static Item runite_pickaxe = new CustomPickaxe("pickaxe_runite", RUNITE);
	public static Item dragonstone_pickaxe = new CustomPickaxe("pickaxe_dragonstone", DRAGONSTONE);
	...
	public void registerItems(RegistryEvent.Register<Item> event) {
		CustomPickaxe.initPickaxeChances();
