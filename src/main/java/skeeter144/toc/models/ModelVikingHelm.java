 ...
 */
public class ModelVikingHelm<T extends LivingEntity> extends BipedModel<T>{
   
    public RendererModel helmBase;
    public RendererModel rightHornBase;
    public RendererModel leftHornBase;
    ...
    public ModelVikingHelm() {
          ...
          this.rightHorn2 = new RendererModel(this, 0, 0);
          ...
          this.rightHornBase = new RendererModel(this, 0, 22);
          ...
          this.leftHorn2 = new RendererModel(this, 0, 0);
          ...
          this.leftHornBase = new RendererModel(this, 0, 0);
