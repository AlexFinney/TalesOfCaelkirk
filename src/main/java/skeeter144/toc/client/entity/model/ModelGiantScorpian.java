...
public class ModelGiantScorpian extends AdvancedModelBase<EntityGiantScorpian> {
    ...
    private void setupModel() {
        ...
        this.body_1.addBox(-9.3F, -4.0F, -8.0F, 18, 9, 24, 0.0F);
    ...
    void setAnimations() {
    	...
    	//strike
    	f2.addPartOrientation(new PartOrientation("body_1", body_1,                         0, 12, 1.5f, 0, 0, 0));
    	f2.addPartOrientation(new PartOrientation("tail_base", tail_base,       			0, 0, 0, 30, 0, 0));
    	f2.addPartOrientation(new PartOrientation("tail_1", tail_1,    			   			0, 0, 0, 30, 0, 0));
    	f2.addPartOrientation(new PartOrientation("tail_2", tail_2,       					0, 0, 0, 15, 0, 0));
    	f2.addPartOrientation(new PartOrientation("tail_3", tail_3,       					0, 0, 0, -15, 0, 0));
