...
public class ModelSiren extends EntityModel<EntitySiren>
{
...
//		updateDefaultPose();
	...
	@Override
	public void setRotationAngles(EntitySiren entitySiren, float v, float v1, float v2, float v3, float v4)
	{
