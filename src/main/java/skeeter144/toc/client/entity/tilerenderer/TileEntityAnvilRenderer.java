...
{
	public TileEntityAnvilRenderer(TileEntityRendererDispatcher p_i226006_1_)
	{
		super(p_i226006_1_);
	}
...
//	}
	...
	@Override
	public void render(TileEntityAnvil tileEntityAnvil, float v, MatrixStack matrixStack, IRenderTypeBuffer iRenderTypeBuffer, int i, int i1)
	{
