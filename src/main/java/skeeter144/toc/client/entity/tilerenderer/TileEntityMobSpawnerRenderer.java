...
public class TileEntityMobSpawnerRenderer extends TileEntityRenderer<TileEntityMobSpawner> {
	...
	public TileEntityMobSpawnerRenderer(TileEntityRendererDispatcher p_i226006_1_)
	{
		super(p_i226006_1_);
	}

	@Override
	public void render(TileEntityMobSpawner tileEntityMobSpawner, float v, MatrixStack matrixStack, IRenderTypeBuffer iRenderTypeBuffer, int i, int i1)
	{
