...
public class RenderRat<T extends LivingEntity, M extends EntityModel<T>> extends LivingRenderer<T, M>{
	private static final ResourceLocation texture = new ResourceLocation(Reference.MODID, "textures/entity/rat.png");
	
	public RenderRat(EntityRendererManager rendermanagerIn, M ModelIn, float shadowsizeIn) {
