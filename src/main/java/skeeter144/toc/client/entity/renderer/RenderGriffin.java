...
public class RenderGriffin<T extends LivingEntity, M extends EntityModel<T>> extends LivingRenderer<T, M>{
	private static final ResourceLocation texture = new ResourceLocation(Reference.MODID, "textures/entity/griffin.png");
	
	public RenderGriffin(EntityRendererManager rendermanagerIn, M ModelIn, float shadowsizeIn) {
