...
public class EntityHumanShopKeeper extends EntityShopKeeper {
	...
	public EntityHumanShopKeeper(EntityType<? extends EntityShopKeeper> type, World world) {
		super(type, world, "general_store");
		if(texture == null)
			texture = new ResourceLocation("toc:textures/entity/sam_derric.png");
	}
	
	public EntityHumanShopKeeper(EntityType<? extends EntityShopKeeper> type, World worldIn, String shopFileName, String textureName) {
