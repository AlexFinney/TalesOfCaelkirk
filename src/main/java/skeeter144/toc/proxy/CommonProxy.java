...
import skeeter144.toc.network.ShowQuestDialogMessage.ShoqQuestDialogMessageHandler;
...
public class CommonProxy 
{
	...
	public void init(FMLInitializationEvent event){
		...
		Network.INSTANCE.registerMessage(ShoqQuestDialogMessageHandler.class, ShowQuestDialogMessage.class, Network.getNextId(), Side.CLIENT);
